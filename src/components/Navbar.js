            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="d-flex">
                        <Link button className="btn btn-secondary mx-1" to="/login" role="button">Login</Link>
                        <Link button className="btn btn-secondary mx-1" to="/signup" role="button">Signup</Link>
                    </form>
                </div>
            </div>
        </nav></div>
